  ...
  return (
    <main className="h-screen w-screen flex flex-col bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex gap-4 p-4 min-h-0 overflow-hidden">
        {/* Column 1: Charts + Previous Month Calendar (20%) */}
        <div className="w-[20%] min-w-0 flex flex-col h-full gap-4 overflow-hidden">
        ...
        {/* Column 2: Current Month Calendar (60%) */}
        <div className="w-[60%] min-w-0 flex flex-col h-full overflow-hidden">
          <GithubCalendar data={data} months={[today]} statusColorMap={statusColorMap} />
        </div>

        {/* Column 3: Next Month Calendar (20%) */}
        <div className="w-[20%] min-w-0 flex flex-col h-full overflow-hidden">
